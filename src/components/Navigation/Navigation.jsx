...
const Navigation = (props) => {
    ...
    let FriendsElement = props.state.FriendsData.map ( friends => <div className={nav.friends__bar}><a href="#"><img src= { friends.FriendsAvatar } /></a></div> )
    ...
    return (
        <nav className={nav.nav}>
            ...
            <div className={nav.nav__friends_border}>
                <NavLink to="/friends" className={navData => navData.isActive ? nav.active : nav.nav__link}>
